...
object SettingsDataScreen : SearchableSettings {
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return persistentListOf(
            ...
            Preference.PreferenceItem.InfoPreference(stringResource(AMR.strings.pref_storage_location_info_anime)),
    ...
    private fun getExportGroup(): Preference.PreferenceGroup {
                    ...
                    LibraryExporter.exportToCsv(
                        ...
                        onExportComplete = {
                            scope.launch(Dispatchers.Main) {
                                context.toast(AMR.strings.library_exported)
                            }
                        },
                    )
                }
        ...
        if (showDialog) {
            ColumnSelectionDialog(
                ...
                onConfirm = { options ->
                    ...
                    saveFileLauncher.launch("anikku_library.csv")
                },
        ...
        return Preference.PreferenceGroup(
            title = stringResource(AMR.strings.export),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.TextPreference(
                    title = stringResource(AMR.strings.library_list),
            ...
            text = {
                Column {
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(text = stringResource(AMR.strings.author))
                    }
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(text = stringResource(AMR.strings.artist))
                    }
                }
            },
            confirmButton = {
