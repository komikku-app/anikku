...
Output: `macos/build/compose/binaries/main/dmg/Anikku-1.1.0.dmg`
...
hdiutil verify build/compose/binaries/main/dmg/Anikku-1.1.0.dmg
```
...
./gradlew submitForNotarization \
  -PdmgPath=build/compose/binaries/main/dmg/Anikku-1.1.0.dmg

xcrun stapler staple build/compose/binaries/main/dmg/Anikku-1.1.0.dmg
```
